...
interface IAlertComponent extends ReturnType<typeof memo> {
...
const Alert: IAlertComponent = memo(() => {
  ...
  return (
    <Dialog open={opened} onClose={params?.onCancel} className={classes.root} keepMounted>
